...
: _ptimeout(0)
{
	...
	_timeout.tv_sec = 0; _timeout.tv_usec = 100000; // 100 ms
}
...
void DocAccessData::SetLoadTimeoutValue(long micro_seconds)
{
	_timeout.tv_usec = micro_seconds;
}

void DocAccessData::SetLoadTimeout()
{
	_ptimeout = _addr.sin_addr.s_addr == inet_addr("127.0.0.1") ? &_timeout : 0;
}
